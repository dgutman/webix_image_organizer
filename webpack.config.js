		...
		plugins: [
			...
			new webpack.EnvironmentPlugin({
				SERVER_LIST: [
					...
					{id: "3", value: "Computable Brain", hostAPI: "https://computablebrain.emory.edu/api/v1"},
					{id: "4", value: "Transplant", hostAPI: "http://transplant.digitalslidearchive.emory.edu:8080/api/v1"},
