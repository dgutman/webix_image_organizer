import checkingFunctions from "./helpingFunctions";
...
function filterData(dataview, value) {
	dataview.filter((obj) => {
		let itemType = checkingFunctions.searchForFileType(obj);
...
function prepareDataToFilter(dataArray) {
	...
	dataArray.forEach((item) => {
		const itemType = checkingFunctions.searchForFileType(item);
